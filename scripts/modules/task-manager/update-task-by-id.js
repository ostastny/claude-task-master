...
async function updateTaskById (
  ...
  try {
    ...
    if (!prompt || typeof prompt !== 'string' || prompt.trim() === '') { throw new Error('Prompt cannot be empty.') }
    ...
    try {
      ...
      if (!updatedTask || typeof updatedTask !== 'object') { throw new Error('Received invalid task object from AI.') }
      if (!updatedTask.title || !updatedTask.description) { throw new Error('Updated task missing required fields.') }
